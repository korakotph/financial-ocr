...
const MENU = [
  { name: 'Dashboard', path: '/',          icon: <IconGrid /> },
  { name: 'Documents', path: '/documents', icon: <IconDoc /> },
  { name: 'Upload',    path: '/upload',    icon: <IconUpload /> },
  { name: 'Reports',   path: '/reports',   icon: <IconChart /> },
  { name: 'Prompt',    path: '/prompt',    icon: <IconEdit /> },
  { name: 'Settings',  path: '/settings',  icon: <IconCog /> },
]
...
function IconUpload() {
  return <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" /></svg>
}
function IconChart() {
      ...
      <div style={{
        ...
        {!collapsed && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontWeight: 700, fontSize: 14, color: '#0f172a' }}>Financial OCR</span>
          </div>
        )}
        <button
